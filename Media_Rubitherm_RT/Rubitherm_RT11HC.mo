...
package Rubitherm_RT11HC "Rubitherm GmbH, RT11HC; data taken from: Rubitherm datasheet; last access: 2020-08-10."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>RT11HC</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: unknown;  encapsulation:    multiple options available<br>  Data taken from: Rubitherm datasheet - last access 2020-08-10.<br><br>
