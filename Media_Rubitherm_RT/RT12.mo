...
package RT12 "Rubitherm RT12; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {2.771500000000000e+02, 2.891500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {2.761500000000000e+02, 2.871500000000000e+02}
    ...
    constant Modelica.Units.SI.SpecificEnthalpy   phTrEnth = 1.102483641764689e+05
             "scalar phase transition enthalpy";

    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 2.771500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT12</strong>.<br><br>
