...
package RT_minus_4 "Rubitherm RT_minus_4, data taken from data_sheet"
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>RT_minus_4</strong>.
