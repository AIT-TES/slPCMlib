...
package RT_minus_4 "Rubitherm RT-4; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 2.631500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT-4</strong>.<br><br>
