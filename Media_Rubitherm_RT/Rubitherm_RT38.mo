...
package Rubitherm_RT38 "Rubitherm GmbH, RT38; data taken from: Rubitherm datasheet."
...
annotation(Documentation(
  ...
  Basic characteristics are the material class: unknown, and encapsulation: multiple options available<br>  The data is taken from: Rubitherm datasheet - last access 2022-11-30.<br><br>
  <br><br>
