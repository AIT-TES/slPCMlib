...
package Rubitherm_RT111HC "Rubitherm GmbH, RT111HC; data taken from: Rubitherm datasheet; last access: 2022-12-06."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>RT111HC</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: unknown;  encapsulation:    multiple options available<br>  Data taken from: Rubitherm datasheet - last access 2022-12-06.<br><br>
