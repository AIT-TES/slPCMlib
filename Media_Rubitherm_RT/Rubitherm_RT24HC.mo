...
package Rubitherm_RT24HC "Rubitherm GmbH, RT24HC; data taken from: Rubitherm datasheet; last access: 2022-11-18."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>RT24HC</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: unknown;  encapsulation:    multiple options available<br>  Data taken from: Rubitherm datasheet - last access 2022-11-18.<br><br>
