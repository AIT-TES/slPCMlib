...
package Rubitherm_RT5HC "Rubitherm GmbH, RT5HC; data taken from: Rubitherm datasheet; last access: 2022-03-21."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>RT5HC</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: unknown;  encapsulation:    multiple options available<br>  Data taken from: Rubitherm datasheet - last access 2022-03-21.<br><br>
