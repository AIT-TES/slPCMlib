...
package RT_minus_9HC "Rubitherm RT_minus_9HC; data taken from: data_sheet; last access: 01.12.2019."
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT_minus_9HC</strong>.<br><br>
