...
package RT54HC "Rubitherm RT54HC; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {3.241500000000000e+02, 3.311500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {3.231500000000000e+02, 3.281500000000000e+02}
    ...
    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 3.241500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT54HC</strong>.<br><br>
