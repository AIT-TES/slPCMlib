...
package Rubitherm_RT12 "Rubitherm GmbH, RT12; data taken from: Rubitherm datasheet."
...
annotation(Documentation(
  ...
  Basic characteristics are the material class: unknown, and encapsulation: multiple options available<br>  The data is taken from: Rubitherm datasheet - last access 2020-08-30.<br><br>
  <br><br>
