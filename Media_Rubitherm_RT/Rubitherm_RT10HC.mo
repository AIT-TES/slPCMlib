...
package Rubitherm_RT10HC "Rubitherm GmbH, RT10HC; data taken from: Rubitherm datasheet; last access: 2020-06-10."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>RT10HC</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: unknown;  encapsulation:    multiple options available<br>  Data taken from: Rubitherm datasheet - last access 2020-06-10.<br><br>
