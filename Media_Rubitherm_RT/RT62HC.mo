...
package RT62HC "Rubitherm RT62HC; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {3.321500000000000e+02, 3.381500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {3.311500000000000e+02, 3.361500000000000e+02}
    ...
    constant Modelica.Units.SI.SpecificEnthalpy   phTrEnth = 1.942042828941463e+05
             "scalar phase transition enthalpy";

    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 3.321500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT62HC</strong>.<br><br>
