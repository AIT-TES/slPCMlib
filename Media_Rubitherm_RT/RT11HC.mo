...
package RT11HC "Rubitherm RT11HC; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {2.781500000000000e+02, 2.871500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {2.781500000000000e+02, 2.861500000000000e+02}
    ...
    constant Modelica.Units.SI.SpecificEnthalpy   phTrEnth = 1.833430289519252e+05
             "scalar phase transition enthalpy";
      
    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 2.781500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT11HC</strong>.<br><br>
