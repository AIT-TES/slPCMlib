...
package Rubitherm_RT8 "Rubitherm GmbH, RT8; data taken from: Rubitherm datasheet."
...
annotation(Documentation(
  ...
  Basic characteristics are the material class: unknown, and encapsulation: multiple options available<br>  The data is taken from: Rubitherm datasheet - last access 2022-12-02.<br><br>
  <br><br>
