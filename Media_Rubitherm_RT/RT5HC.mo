...
package RT5HC "Rubitherm RT5HC; data taken from: data_sheet; last access: 01.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {2.741500000000000e+02, 2.801500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {2.741500000000000e+02, 2.791500000000000e+02}
    ...
    // --- reference values ---
    constant Modelica.Units.SI.Temperature            Tref = 2.741500000000000e+02
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>Rubitherm RT5HC</strong>.<br><br>
