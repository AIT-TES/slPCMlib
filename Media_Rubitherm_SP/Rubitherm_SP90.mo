...
package Rubitherm_SP90 "Rubitherm GmbH, SP90; data taken from: Rubitherm datasheet."
...
annotation(Documentation(
  ...
  Basic characteristics are the material class: salt hydrate-based, and encapsulation: multiple options available<br>  The data is taken from: Rubitherm datasheet - last access 2020-11-24.<br><br>
  <br><br>
