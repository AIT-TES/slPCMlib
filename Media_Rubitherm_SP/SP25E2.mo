...
package SP25E2 "Rubitherm SP25E2; data taken from: data sheet; last access: 02.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {2.911500000000000e+02, 3.011500000000000e+02}
    ...
    constant Modelica.Units.SI.SpecificEnthalpy   phTrEnth = 1.278063769193438e+05
