...
package Rubitherm_SP70 "Rubitherm GmbH, SP70; data taken from: Rubitherm datasheet; last access: 2020-11-24."
...
annotation(Documentation(
  ...
  This package contains solid and liquid properties for the PCM:  <strong>SP70</strong>  from manufacturer: <strong>Rubitherm GmbH</strong>.<br>
       material class: salt hydrate-based;  encapsulation:    macroencapsulation<br>  Data taken from: Rubitherm datasheet - last access 2020-11-24.<br><br>
