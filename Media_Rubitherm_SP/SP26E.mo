...
package SP26E "Rubitherm SP26E; data taken from: data sheet; last access: 02.12.2019."
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.Units.SI.Temperature rangeTmelting[2] =  {2.941500000000000e+02, 3.011500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.Units.SI.Temperature rangeTsolidification[2] = {2.931500000000000e+02, 2.991500000000000e+02}
    ...
    constant Modelica.Units.SI.SpecificEnthalpy   phTrEnth = 1.578896722849477e+05
...
annotation(Documentation(
  ...
  revisions="<html>
  <ul>
  <li>file creation date: 06-Jul-2022  </ul>
  </html>"));
end SP26E;
