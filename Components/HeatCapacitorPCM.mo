...
//                choice(replaceable slPCMlib.Interfaces.phTransModCurveTrackHysteresis
//                   phTrModel(redeclare package PCM = PCM)  "phTransModCurveTrackHysteresis"),
//                choice(replaceable slPCMlib.Interfaces.phTransModCurveScaleHysteresisDiff
//                   phTrModel(redeclare package PCM = PCM)  "phTransModCurveScaleHysteresisDiff"),
//                choice(replaceable slPCMlib.Interfaces.phTransModCurveScaleHysteresisAlgebraic
//                   phTrModel(redeclare package PCM = PCM)  "phTransModCurveScaleHysteresisAlgebraic"),
//                choice(replaceable slPCMlib.Interfaces.phTransModCurveSwitchHysteresis
//                   phTrModel(redeclare package PCM = PCM)  "phTransModCurveSwitchHysteresis")));

//                  choicesAllMatching=true);

//      redeclare replaceable slPCMlib.Interfaces.phTransModMeltingCurve
//                  phTrModel(redeclare package PCM = PCM)
