...
package PLUSS_savE_HS7N "Pluss Advanced Technologies Pvt Ltd, HS7N; data taken from: PLUSS datasheet."
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>HS7N</strong>  from manufacturer: <strong>Pluss Advanced Technologies Pvt Ltd</strong>.<br>
