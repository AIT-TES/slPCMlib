...
package PLUSS_savE_HS78 "Pluss Advanced Technologies Pvt Ltd, HS78; data taken from: PLUSS datasheet."
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>HS78</strong>  from manufacturer: <strong>Pluss Advanced Technologies Pvt Ltd</strong>.<br>
