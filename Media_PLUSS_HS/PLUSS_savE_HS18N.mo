...
package PLUSS_savE_HS18N "Pluss Advanced Technologies Pvt Ltd, HS18N; data taken from: PLUSS datasheet."
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>HS18N</strong>  from manufacturer: <strong>Pluss Advanced Technologies Pvt Ltd</strong>.<br>
