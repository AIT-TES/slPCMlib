...
package PLUSS_savE_HS30N "Pluss Advanced Technologies Pvt Ltd, HS30N; data taken from: PLUSS datasheet."
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>HS30N</strong>  from manufacturer: <strong>Pluss Advanced Technologies Pvt Ltd</strong>.<br>
