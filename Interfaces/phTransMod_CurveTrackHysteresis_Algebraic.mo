...
model phTransMod_CurveTrackHysteresis_Algebraic
  "Curve track hysteresis model, static (algebraic equations) - obsolete -"
...
end phTransMod_CurveTrackHysteresis_Algebraic;
