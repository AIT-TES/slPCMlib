...
package RT42 "Rubitherm RT42, data taken from data_sheet"
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.SIunits.Temp_K rangeTmelting[2] =  {3.091500000000000e+02, 3.171500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.SIunits.Temp_K rangeTsolidification[2] = {3.081500000000000e+02, 3.171500000000000e+02}
    ...
    constant Modelica.SIunits.SpecificEnthalpy   phTrEnth = 1.297905932028317e+05
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>RT42</strong>.
