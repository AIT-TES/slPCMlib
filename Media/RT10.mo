...
package RT10 "Rubitherm RT10, data taken from data_sheet"
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.SIunits.Temp_K rangeTmelting[2] =  {2.751500000000000e+02, 2.861500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.SIunits.Temp_K rangeTsolidification[2] = {2.751500000000000e+02, 2.841500000000000e+02}
    ...
    constant Modelica.SIunits.SpecificEnthalpy   phTrEnth = 1.281475284698701e+05
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>RT10</strong>.
