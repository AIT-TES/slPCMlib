...
package RT5 "Rubitherm RT5, data taken from data_sheet"
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.SIunits.Temp_K rangeTmelting[2] =  {2.721500000000000e+02, 2.801500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.SIunits.Temp_K rangeTsolidification[2] = {2.711500000000000e+02, 2.801500000000000e+02}
    ...
    constant Modelica.SIunits.SpecificEnthalpy   phTrEnth = 1.242052446212872e+05
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>RT5</strong>.
