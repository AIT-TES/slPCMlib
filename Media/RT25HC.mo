...
package RT25HC "Rubitherm RT25HC, data taken from data_sheet"
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.SIunits.Temp_K rangeTmelting[2] =  {2.901500000000000e+02, 3.001500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.SIunits.Temp_K rangeTsolidification[2] = {2.891500000000000e+02, 2.991500000000000e+02}
    ...
    constant Modelica.SIunits.SpecificEnthalpy   phTrEnth = 1.795288869777121e+05
...
annotation(Documentation(
  info="<html>
  <p>
  This package contains solid and liquid properties for the PCM:  <strong>RT25HC</strong>.
