...
package RT3HC "Rubitherm RT3HC, data taken from data_sheet"
  ...
  redeclare replaceable record propData "PCM record"
    ...
    constant Modelica.SIunits.Temp_K rangeTmelting[2] =  {2.691500000000000e+02, 2.791500000000000e+02}
             "temperature range melting {startT, endT}";
    constant Modelica.SIunits.Temp_K rangeTsolidification[2] = {2.691500000000000e+02, 2.771500000000000e+02}
    ...
    constant Modelica.SIunits.SpecificEnthalpy   phTrEnth = 1.445107429767713e+05
