...
//           +  coefs[intNum,7]*dT*dT*dT*dT*dT*dT;
  ...
  annotation (Icon(graphics,
      ...
      coordinateSystem(preserveAspectRatio=false)),
          ...
          <p>
          Function for the evaluation of variable-order (>4) piecewise splines described in  
          </p>
          <blockquote>          
          <p>
          ...
          <p> 
          The result (piecewise polynom) is three times continuously 
          differentiable (C3 smooth). 
          It is used for modeling the phase transition function <var> xi </var>.  
          </p>
          </html>",
    revisions="<html>
        <ul>
        <li>2022-07-04; initial version; by Tilman Barz </li>
        </ul>
        </html>"));
end quartQuintSplineEval;
